                ...
                <div class="col-md-6" style="margin-left: 350px;">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">课程信息拒绝理由</h3>
                        </div>
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form action="${pageContext.request.contextPath}/education/addRefuse.do" method="post">
                            <div class="box-body">
                                <div class="form-group">
                                    <label>课程号</label>
                                    <input type="text" class="form-control" name="courseId" value="${courseId}" readonly>
                                </div>
                                <div class="form-group">
                                    <label>课程名</label>
                                ...
                                <div class="form-group">
                                    <label>拒绝理由</label>
                                    <input type="text" class="form-control" name="refuseReason" placeholder="请输入...">
                                </div>
                            </div>
                            <!-- /.box-body -->
